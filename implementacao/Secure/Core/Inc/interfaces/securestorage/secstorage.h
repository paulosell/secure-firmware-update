...
#define NEW_FIRMWARE_SIGNATURE_ADDRESS   		((uint32_t)0x0803D000)
#define NEW_FIRMWARE_VERSION_ADDRESS			(NEW_FIRMWARE_SIGNATURE_ADDRESS + 256) //0x0803D100
#define NEW_FIRMWARE_SIZE_ADDRESS				(NEW_FIRMWARE_VERSION_ADDRESS + 16) //  0x0803D110
